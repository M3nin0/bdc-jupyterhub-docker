...
"""Configuration file for the Brazil Data Cube JupyterHub documentation.
...
import bdc_jupyterhub
import sphinx_rtd_theme


# -- Project information -----------------------------------------------------

project = 'BDC_JUPYTERHUB'
copyright = '2021, INPE.'
author = 'Brazil Data Cube Team'
release = bdc_jupyterhub.__version__
...
html_title = 'BDC_JUPYTERHUB'

html_context = {
    'display_github': False,
    'github_user': 'brazil-data-cube',
    'github_repo': 'bdc-jupyterhub',
    'last_updated': False,
    #'commit': False,
}
...
#import os
#
#BDC_JUPYTERHUB_EXAMPLE_URL = os.getenv('BDC_JUPYTERHUB_EXAMPLE_URL', None)
#'''
